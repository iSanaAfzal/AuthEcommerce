                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="blog-item">
                                ...
                                <!-- Image -->
                                <div class="img"><img src="url{{images/blog/details.jpg}}" alt="blog"></div>
                                ...
                                <div class="content fix">
                                    ...
                                    <div class="row row-5 mb-20">
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="url{{images/blog/blog-gallery-1.jpg}}" alt=""></div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="url{{images/blog/blog-gallery-2.jpg}}" alt=""></div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="url{{images/blog/blog-gallery-3.jpg}}" alt=""></div>
                                    </div>
                                ...
                                <ul class="comment-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="single-comment fix">
                                            ...
                                            <div class="image float-left">
                                                <img src="url{{images/comment/1.jpg}}" alt="">
                                            </div>
                                        ...
                                        <ul class="child-comment">
                                            ...
                                            <li>
                                                ...
                                                <div class="single-comment fix">
                                                    ...
                                                    <!-- Image -->
                                                    <div class="image float-left">
                                                        <img src="url{{images/comment/2.jpg}}" alt="">
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="single-comment fix">
                                            ...
                                            <!-- Image -->
                                            <div class="image float-left">
                                                <img src="url{{images/comment/3.jpg}}" alt="">
                                            </div>
                    ...
                    <div class="sidebar-wrapper">
                        ...
                        <div class="single-sidebar mb-30">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.html" class="image"><img src="url{{img/blog/sidebar-post-1.jpg}}" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.html" class="image"><img src="url{{img/blog/sidebar-post-2.jpg}}" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
