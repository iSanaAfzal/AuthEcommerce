                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="route{{ 'product-details' }}" class="img"><img src="images/product/1.jpg"
                                            alt="Product"></a>
                                    <!-- Wishlist -->
                                ...
                                <div class="content">
                                    ...
                                    <div class="head fix">
                                        ...
                                        <div class="title-category float-left">
                                            <h5 class="title"><a href="route{{ 'product-details' }}">Holiday Candle</a>
                                            </h5>
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <!-- Assuming $quantity is the variable holding the actual quantity value -->
                                        <input type="hidden" name="Product_Name" value="Holiday Candle">
                                        <input type="hidden" name="price" value="38.8">
                                        <input type="hidden" name="image" value="images/product/1.jpg">

                                        <button type="submit"class="btn btn-dark">Add to Cart</button>
                                    </form>
                                    {{-- <div class="action-button fix">
                                    <a href="route{{('Layouts.checkout')}}">add to cart</a>
                                </div> --}}
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="product-details.html" class="img">
                                ...
                                <div class="content">
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="quantity" value=" 1">
                                        <!-- Assuming $quantity is the variable holding the actual quantity value -->
                                        <input type="hidden" name="Product_Name" value="Christmas Tree">
                                        <input type="hidden" name="price" value="38.8">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="route{{ 'product-details' }}" class="img"><img
                                            src="{{ 'images/product/3.jpg' }}" alt="Product"></a>
                                    <!-- Wishlist -->
                                    <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                                    <!-- Label -->
                                    <!-- <span class="label">New</span> -->
                                ...
                                <div class="content">
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="quantity" value=" 1">
                                        <!-- Assuming $quantity is the variable holding the actual quantity value -->
                                        <input type="hidden" name="Product_Name" value="santa class Doll">
                                        <input type="hidden" name="price" value="38.8">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="route{{ 'product-details' }}" class="img"><img
                                            src="{{ 'images/product/4.jpg' }}" alt="Product"></a>
                                    <!-- Wishlist -->
                                    <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                                    <!-- Label -->
                                    <span class="label">New</span>
                                ...
                                <div class="content">
                                    ...
                                    <div class="head fix">
                                        ...
                                        <!-- Title & Category -->
                                        <div class="title-category float-left">
                                            <h5 class="title"><a href="route{{ 'product-details' }}">Holiday Cap</a>
                                            </h5>
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="quantity" value=" 1">
                                        <!-- Assuming $quantity is the variable holding the actual quantity value -->
                                        <input type="hidden" name="Product_Name" value="Holiday Cap">
                                        <input type="hidden" name="price" value="38.8">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="route{{ 'product-details' }}" class="img"><img
                                            src="{{ 'images/product/5.jpg' }}" alt="Product"></a>
                                    <!-- Wishlist -->
                                    <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                                    <!-- Label -->
                                    <!-- <span class="label">New</span> -->
                                ...
                                <div class="content">
                                    ...
                                    <div class="head fix">
                                        ...
                                        <!-- Title & Category -->
                                        <div class="title-category float-left">
                                            <h5 class="title"><a href="route{{ 'product-details' }}">Holiday Doll</a>
                                            </h5>
                                            <a href="route{{ 'shop' }}" class="category">Catalog</a>
                                        </div>
                                        <!-- Price -->
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="quantity" value=" 1">
                                        <!-- Assuming $quantity is the variable holding the actual quantity value -->
                                        <input type="hidden" name="Product_Name" value="Holiday Doll">
                                        <input type="hidden" name="price" value="38.8">
                                        <input type="hidden" name="image" value="images/product/5.jpg">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-60">
                            ...
                            <div class="product">
                                ...
                                <div class="image">
                                    <!-- Image -->
                                    <a href="route{{ 'product-details' }}" class="img"><img
                                            src="{{ 'images/product/6.jpg' }}" alt="Product"></a>
                                    <!-- Wishlist -->
                                    <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                                    <!-- Label -->
                                    <!-- <span class="label">New</span> -->
                                ...
                                <div class="content">
                                    ...
                                    <div class="head fix">
                                        ...
                                        <!-- Title & Category -->
                                        <div class="title-category float-left">
                                            <h5 class="title"><a href="route{{ 'product-details' }}">Holiday
                                                    Candle</a></h5>
                                            <a href="route{{ 'shop' }}" class="category">Catalog</a>
                                        </div>
                                        <!-- Price -->
                                    ...
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="Product_Name" value="Holiday Candle">
                                        <input type="hidden" name="price" value="38.8">
                                        <input type="hidden" name="image" value="images/product/6.jpg">
