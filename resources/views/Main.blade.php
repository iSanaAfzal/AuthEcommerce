                                ...
                                <div class="product">
                                    ...
                                    <div class="content">
                                        ...
                                        {{-- <form action="{{ route('cart.add') }}" method="POST">
                                            ...
                                            <input type="hidden"name="product_name" placeholder="Product Name"
                                                value={{ $product->Name }} readonly>
                                            <textarea name="description" placeholder="Product Description" readonly style="display: none;">{{ $product->Description }}</textarea>
